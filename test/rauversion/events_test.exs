defmodule Rauversion.EventsTest do
  ...
  describe "event" do
    ...
    @invalid_attrs %{
      ...
      event: nil,
      event_capacity: nil,
      event_capacity_limit: nil,
      event_ends: nil,
      event_settings: nil,
      event_short_link: nil,
      event_start: nil,
      location: nil,
      online: nil,
      order_form: nil,
    ...
    test "update_event/2 with valid data updates the event" do
      ...
      update_attrs = %{
        age_requirement: "some updated age_requirement",
        attendee_list_settings: %{},
        ...
        event_capacity_limit: 43,
        event_ends: ~N[2022-08-13 17:38:00],
        event_start: ~U[2022-08-13 17:38:00Z],
        event_settings: %{},
        event_short_link: "some updated event_short_link",
