defmodule Ueberauth.Strategy.Discord do
  ...
  @doc """
  Handles the initial redirect to the Discord authentication page.
  You can also include a `state` param that Discord will return to you.
  """
  ...
  @doc """
  Stores the raw information (including the token) obtained from the Discord callback.
  """
  def extra(conn) do
    %Extra{
      raw_info: %{
