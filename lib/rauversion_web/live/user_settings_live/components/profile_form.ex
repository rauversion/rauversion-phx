          ...
          <div class="sm:col-span-6">
            ...
            <div class="mt-1 flex rounded-md shadow-sm">
              ...
              <%= text_input(f, :username,
                required: true,
                class:
                  "flex-1 block w-full min-w-0 border-blue-gray-300 rounded-none rounded-r-md text-blue-gray-900 dark:text-blue-gray-100 dark:bg-gray-900 sm:text-sm focus:ring-blue-500 focus:border-blue-500"
              ) %>
            </div>
          </div>
