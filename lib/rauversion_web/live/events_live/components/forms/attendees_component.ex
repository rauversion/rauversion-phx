      ...
      <div class="px-4 sm:px-6 lg:px-8 w-full">
        <div class="sm:flex sm:items-center">
          <div class="sm:flex-auto">
            <h1 class="text-xl font-semibold text-gray-900 dark:text-gray-100"><%= gettext("Users") %></h1>
            <p class="mt-2 text-sm text-gray-700 dark:text-gray-300"><%= gettext("A list of all the users in your account including their name, title, email and role.") %></p>
          </div>
          <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
            <button type="button"
              phx-click="open_modal"
              phx-target={@myself}
              class="inline-flex items-center justify-center rounded-md border border-transparent bg-brand-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-brand-700 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2 sm:w-auto">Add user</button>
          </div>
        </div>
