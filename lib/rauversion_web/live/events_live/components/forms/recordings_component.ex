        ...
        <%= if @display_form do %>
          ...
          <.form
            ...
            <div class="space-y-3">
              ...
              <%= form_input_renderer(f, %{type: :text_input, name: :title, wrapper_class: "", placeholder: "recording title"}) %>
              <%= form_input_renderer(f, %{type: :textarea, name: :description, wrapper_class: "", placeholder: "recording description here"}) %>
              <%= form_input_renderer(f, %{type: :text_input, name: :iframe, wrapper_class: "", placeholder: "iframe link, ie:: https//video.com/1223"}) %>
          ...
          <%= for item <- @event_recordings do %>
            <li class="relative">
              ...
              <div class="flex justify-center space-x-2">
                <%= link "delete", to: "#", class: "text-xs text-red-800", phx_target: @myself, phx_click: "delete", phx_value_id: item.id, "data-confirm": "Are you sure?" %>
                <%= link "edit", to: "#", class: "text-xs", phx_target: @myself, phx_click: "edit", phx_value_id: item.id %>
              </div>
            </li>
          <% end %>
        </ul>
