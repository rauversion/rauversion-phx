        ...
        <.form
          ...
          <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
            ...
            <div class="sm:col-span-6">
              ...
              <%= form_input_renderer(f, %{type: :datetime_input, name: :event_start, wrapper_class: nil}) %>
              <%= form_input_renderer(f, %{type: :datetime_input, name: :event_ends, wrapper_class: nil}) %>
