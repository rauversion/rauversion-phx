    ...
    <%= if is_creator?(@current_user) do %>
      ...
      <div class="space-y-2">
        ...
        <.form
          ...
          <label for="add-team-members" class="mt-4 block text-sm font-medium text-gray-700 dark:text-gray-300">
          ...
          <div class="flex">
            ...
            <span class="ml-3">
              <button type="submit"
                ...
                <svg class="-ml-2 mr-1 h-5 w-5 text-gray-400" x-description="Heroicon name: mini/plus" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
