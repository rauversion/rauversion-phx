        ...
        >
            ...
            <div class="bg-brand-700 py-6 px-4 sm:px-6">
              ...
              <div class="mt-1">
                <p class="text-sm text-brand-300">
                  <%= gettext(
                    "Get started by filling in the information below to create your new article."
                  ) %>
                </p>
              </div>
            </div>
            <div class="flex flex-1 flex-col justify-between dark:bg-black dark:text-white">
              <div class="divide-y divide-gray-200 dark:divide-gray-800 px-4 sm:px-6">
                  ...
                  <div class="mt-1 sm:mt-0 sm:col-span-2">
                    ...
                    >
                      <div class="space-y-1 text-center">
                        ...
                        <% else %>
                          <%= img_tag(
                            Rauversion.Posts.proxy_cover_representation_url(@post, %{
                              resize_to_limit: "300x70"
                            }),
                ...
                <div class="space-y-6 pt-6 pb-5">
                  <div>
                    ...
                    <div class="mt-1">
                      <%= text_input(f, :title,
                        class:
                          "block w-full rounded-md border-gray-300 shadow-sm focus:border-brand-500 focus:ring-brand-500 sm:text-sm dark:bg-gray-900 dark:text-gray-100"
                      ) %>
                      <%= error_tag(f, :title) %>
                    </div>
                  </div>
                    ...
                    <div class="mt-2 space-y-5">
                      ...
                      <div>
                        <div class="relative flex items-start">
                          ...
                          <div class="pl-7 text-sm">
                            <label
                              for="privacy-private-to-article"
                              class="font-medium text-gray-900 dark:text-gray-100"
                            >
                      ...
                      <div>
                        <div class="relative flex items-start">
                          ...
                          <div class="pl-7 text-sm">
                            <label
                              for="privacy-published-to-article"
                              class="font-medium text-gray-900 dark:text-gray-100"
                            >
                ...
                <%= form_input_renderer(f, %{
                  ...
                  type: :select,
                  options:
                    Rauversion.Categories.list_categories() |> Enum.map(fn x -> {x.name, x.id} end),
                  wrapper_class: ""
                }) %>
                ...
                <div class="pt-4 pb-6">
                  <div class="flex text-sm">
                    ...
                    >
                      <svg
                        class="h-5 w-5 text-brand-500 group-hover:text-brand-900"
                  ...
                  <div class="mt-4 flex text-sm">
                    <a
                      href="#"
                      class="group inline-flex items-center text-gray-500 hover:text-gray-900 dark:text-gray-100"
                    >
                      <svg
                        class="h-5 w-5 text-gray-400 dark:text-gray-100 group-hover:text-gray-500"
          ...
          <div class="flex flex-shrink-0 justify-end px-4 py-4 dark:bg-gray-900">
            ...
            <%= submit(gettext("Save"),
              ...
              class:
                "ml-4 inline-flex justify-center rounded-md border border-transparent bg-brand-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-brand-700 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2"
            ) %>
          </div>
        </.form>
      </div>
