        ...
        <div>
          ...
          <div class="hidden sm:block">
            <nav class="flex space-x-4" aria-label="Tabs" data-controller="tabs">
              ...
              <a href="#" data-tab="#basic-info" data-action="click->tabs#changeTab" class="tab-link bg-orange-100 text-orange-700 px-3 py-2 font-medium text-sm rounded-md"> Basic Info </a>
              <a href="#"  data-tab="#metadata" data-action="click->tabs#changeTab" class="tab-link text-orange-500 hover:text-orange-700 px-3 py-2 font-medium text-sm rounded-md"> Metadata </a>
              <a href="#" data-tab="#permissions" data-action="click->tabs#changeTab" class="tab-link text-orange-500 hover:text-orange-700 px-3 py-2 font-medium text-sm rounded-md" aria-current="page"> Permissions </a>
              <a href="#" data-tab="#share" data-action="click->tabs#changeTab" class="tab-link text-orange-500 hover:text-orange-700 px-3 py-2 font-medium text-sm rounded-md"> Share </a>
            </nav>
            ...
            <div id="metadata" class="tab-pane hidden">
              <div class="pt-8">
                <div>
                  <h3 class="text-lg leading-6 font-medium text-gray-900">
            ...
            <div id="share" class="tab-pane hidden">3kkk</div>
