              ...
              <div class="pt-8 space-y-8 divide-y divide-gray-200 sm:space-y-5">
                <div>
                  ...
                  <div class="mt-6 sm:mt-5 space-y-6 sm:space-y-5">
                    ...
                    <div class="mt-1 sm:mt-0 sm:col-span-2">
                      <div class="max-w-lg flex rounded-md shadow-sm">
                        <%= textarea f, :description, "data-controller": "editor", class: "flex-1 block w-full focus:ring-orange-500 focus:border-orange-500 min-w-0 rounded-none rounded-r-md sm:text-sm border-gray-300" %>
