      ...
      <div class="overflow-hidden p-6 mb-0 leading-4 text-left bg-white border border-solid border-zinc-300 text-zinc-900 rounded-md">
        <div class="flex text-left">
          ...
          <div class="overflow-hidden flex-1 font-sans text-zinc-800">
            ...
            <div class="">
              <%= if @track.private do %>
                <span class="inline-block relative p-1 mb-1 font-thin text-white bg-brand-600 rounded border border-transparent border-solid hover:bg-neutral-200 hover:text-neutral-400">
                  <%= gettext("Private") %>
                </span>
              <% end %>
            </div>
            ...
            <div class="flex justify-between items-center">
              <div class="text-sm font-thin leading-5">
                ...
                <%= live_redirect to: Routes.track_show_path(@socket, :show, @track.slug), class: "font-normal text-blue-500 cursor-pointer hover:text-zinc-800" do %>
          ...
          <div class="flex flex-col pl-4 w-56 font-thin bg-white border-l border-solid border-zinc-100 text-neutral-400">
            ...
            <div class="table clear-both">
              ...
              <input
                type="text"
                value={
                  Routes.track_show_url(@socket, :show, @track,
