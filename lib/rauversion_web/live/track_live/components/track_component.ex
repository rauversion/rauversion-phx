defmodule RauversionWeb.TrackLive.TrackComponent do
  ...
  def render(
    ...
    ~H"""
    <div id={"track-item-#{track.id}"} class="flex flex-col sm:flex-row border border-r-0 border-l-0 dark:border-white rounded-md- shadow-sm sm:shadow-md my-2">
      ...
      <div class="w-full">
        ...
        <div class="bg-gray-50 dark:bg-gray-900 border-l-4 border-gray-700 dark:border-gray-900 p-4 mt-2 mr-2">
          <div class="flex">
