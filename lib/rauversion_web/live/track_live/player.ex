    ...
    >
      <%= if @track do %>
        ...
        >
          <div class="flex text-white items-center justify-center space-x-3">
            ...
            <button type="button" data-action="player#rew" data-player-target="rew">
              <svg
                viewBox="0 0 15 15"
                aria-label="fwd"
                fill="none"
              ...
              >
                <path
                  d="M14.5 12.5v-10l-7 5 7 5zm-7 0v-10l-7 5 7 5z"
                  stroke="currentColor"
            ...
            <button type="button" data-action="player#next" data-player-target="next">
              <svg
                viewBox="0 0 15 15"
                aria-label="fwd"
                fill="none"
              ...
              >
                <path
                  d="M.5 12.5v-10l7 5-7 5zm7 0v-10l7 5-7 5z"
                  stroke="currentColor"
                  stroke-linejoin="round"
                >
                </path>
      ...
      <%= if @slideover do %>
        <div
          ...
          class="pointer-events-none fixed inset-y-0 right-0 flex max-w-full bg-white dark:bg-black"
        >
