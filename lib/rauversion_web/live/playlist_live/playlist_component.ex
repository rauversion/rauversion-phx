              ...
              <div class="p-2 sm:p-0 sm:pt-2 flex items-center space-x-1" data-turbo="false">
                ...
                <%= if @current_user && @current_user.id == @playlist.user_id do %>
                  ...
                  <%= link to: "#",
                    ...
                    phx_target: @list_ref,
                    data: [confirm: "Are you sure?"], class: "inline-flex items-center px-2.5 py-1.5 border border-gray-300 shadow-sm text-xs font-medium rounded text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" do %>
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor">
