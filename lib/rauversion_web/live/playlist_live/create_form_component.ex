    ...
    <div class="space-y-8 divide-y divide-gray-200 dark:divide-gray-800 sm:space-y-5">
      <div class="mx-2 py-6">
        <div class="relative">
          ...
          <section
            id="add-to-tab"
            class={"tab-pane py-4 #{if @tab === "add-to-tab" do "block" else "hidden" end }"}
          >
          ...
          <section
            id="create-playlist-tab"
            class={"tab-pane py-4 #{if @tab === "create-playlist-tab" do "block" else "hidden" end }"}
          >
