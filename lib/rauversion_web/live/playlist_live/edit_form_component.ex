      ...
      >
                ...
                <div class="flex items-center space-x-4">
                  ...
                  <div>
                    <a
                      ...
                      target={@ref}
                      class="inline-flex items-center shadow-sm px-2.5 py-0.5 border border-gray-300 dark:border-gray-700 dark:border-gray-700 text-sm leading-5 font-medium rounded-full text-gray-700 dark:text-gray-300 bg-white dark:bg-black hover:bg-gray-50 dark:hover:bg-gray-900"
                    >
                      <%= gettext("remove") %>
                    </a>
                  </div>
          ...
          <%= inputs_for f, :metadata, fn i -> %>
            <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
              <div class="sm:col-span-4">
                ...
                <%= text_input(i, :buy_link,
                  class:
                    "max-w-lg shadow-sm block w-full focus:ring-brand-500 focus:border-brand-500 sm:text-sm border border-gray-300 dark:border-gray-700 rounded-md dark:bg-gray-700 dark:text-gray-100"
                ) %>
                <%= error_tag(i, :buy_link) %>
              </div>
              <div class="sm:col-span-6">
                <%= label(i, :record_label,
                  class: "block text-sm font-medium text-gray-700 dark:text-gray-300"
                ) %>
                <%= text_input(i, :record_label,
                  class:
                    "max-w-lg shadow-sm block w-full focus:ring-brand-500 focus:border-brand-500 sm:text-sm border border-gray-300 dark:border-gray-700 rounded-md dark:bg-gray-700 dark:text-gray-10"
                ) %>
        ...
        <div class="sm:col-span-6">
          <div class="flex justify-end space-x-2">
            ...
            <button
              type="submit"
              class="bg-white py-2 px-4 border border-gray-300 dark:border-gray-700 dark:border-gray-700 rounded-md shadow-sm text-sm font-medium text-gray-700 dark:text-gray-300 dark:bg-black hover:bg-gray-50 dark:hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-500"
            >
              <%= gettext("Cancel") %>
            </button>
          </div>
