      ...
      <div id="basic-info" class={"tab-pane #{ active_tab_for?(@current_tab, "basic-info-tab")}"}>
        <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
          ...
          <div class="sm:col-span-4">
            ...
            <%= textarea f, :description, class: "max-w-lg shadow-sm block w-full focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border border-gray-300 rounded-md" %>
        ...
        <%= inputs_for f, :metadata, fn i -> %>
          <div class="mt-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
            <div class="sm:col-span-4">
              ...
              <%= text_input i, :buy_link, class: "max-w-lg shadow-sm block w-full focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border border-gray-300 rounded-md" %>
              <%= error_tag i, :buy_link %>
            </div>
            <div class="sm:col-span-6">
              <%= label i, :record_label, class: "block text-sm font-medium text-gray-700" %>
              <%= text_input i, :record_label, class: "max-w-lg shadow-sm block w-full focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm border border-gray-300 rounded-md" %>
